...
{
    /// <summary>
    /// Matches a <see cref = "Result{TValue,TError}" /> instance to a value of type <typeparamref name = "TMap" /> based on the state.
    /// </summary>
    ...
    /// <summary>
    /// Matches a <see cref = "Result{TError}" /> instance to a value of type <typeparamref name = "TMap" /> based on the state.
    /// </summary>
    /// <returns>A value of type <typeparamref name = "TMap" />.</returns>
